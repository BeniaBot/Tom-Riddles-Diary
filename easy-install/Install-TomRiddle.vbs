...
Sub AddRich(nm, rng)
    ...
    Next
    Err.Clear
    word.AutoCorrect.Entries.AddRichText nm, rng
    On Error GoTo 0
End Sub
...
End Sub
Announce U("1502 1514 1511 1497 1503 32 1488 1514 32 1514 1493 1501 32 1512 1497 1491 1500 46 46 46 32 1494 1492 32 1488 1493 1512 1498 32 1499 1491 1511 1492 46 32 1492 1502 1514 1503 32 1500 1492 1493 1491 1506 1514 32 1492 1505 1497 1493 1501 46")
...
' document it reproducibly CRASHES Word (RPC 0x800706BE).
Set tDoc = word.Documents.Add(word.NormalTemplate.FullName, False, 0, False)
' no alignment set: template default (RTL profile) is already right-
' aligned, and ParagraphFormat writes crash a windowless document
...
If Err.Number <> 0 Then saveNote = " [!] " & Err.Description
Err.Clear
On Error GoTo 0
If createdWord Then word.Quit
Announce U("1514 1493 1501 32 1512 1497 1491 1500 32 1502 1493 1499 1503 33 32 1504 1513 1502 1512 1493 32") & n & U("32 1500 1493 1495 1493 1514 46 32 1504 1505 1492 32 1489 1493 1493 1512 1491 58 32 32 1492 1497 1497 32 1510 1488 1496") & saveNote
